...
const Signup = () => {
  ...
  return (
    <section className="flex flex-col max-h-[400px] items-center justify-center">
      <div className="flex flex-col min-w-[600px] overflow-auto p-4 rounded-3xl bg-[#97cff5c9]/10 scrollbar transition">
        {!showForm ? (
          <div className="flex items-center justify-center text-[#4aaef1c9] font-bold rounded-3xl w-full urban">
            Preparing your membership form...
          </div>
        ) : (
          <div>
