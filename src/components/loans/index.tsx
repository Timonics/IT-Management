...
const Loans = () => {
  return (
    <div className="bg-[#ffffff8e] rounded-3xl p-4 flex flex-col gap-4 mx-2 items-center">
      <h2 className="urban text-3xl text-start w-full">Loans</h2>
      ...
      <div className="h-[270px] w-full rounded-2xl bg-gray-400 flex flex-col items-center justify-center urban">Loans chart comes here</div>
